...
const basicElements: Partial<PeriodicElement>[] = [
  { atomicNumber: 15, symbol: 'P', name: 'Phosphorus', x: 15, y: 3, category: 'nonmetal' },
  { atomicNumber: 16, symbol: 'S', name: 'Sulfur', x: 16, y: 3, category: 'nonmetal' },
  { atomicNumber: 17, symbol: 'Cl', name: 'Chlorine', x: 17, y: 3, category: 'halogen' },
  { atomicNumber: 18, symbol: 'Ar', name: 'Argon', x: 18, y: 3, category: 'noble-gas' },
  { atomicNumber: 19, symbol: 'K', name: 'Potassium', x: 1, y: 4, category: 'alkali-metal' },
  { atomicNumber: 20, symbol: 'Ca', name: 'Calcium', x: 2, y: 4, category: 'alkaline-earth-metal' },
  ...
  { atomicNumber: 29, symbol: 'Cu', name: 'Copper', x: 11, y: 4, category: 'transition-metal' },
  ...
  { atomicNumber: 47, symbol: 'Ag', name: 'Silver', x: 11, y: 5, category: 'transition-metal' },
  ...
  { atomicNumber: 78, symbol: 'Pt', name: 'Platinum', x: 10, y: 6, category: 'transition-metal' },
